...
public class Userform {
    ...
    public String getFassignedtoId() {
        return fassignedtoId;
    }

    public void setFassignedtoId(String fassignedtoId) {
        this.fassignedtoId = fassignedtoId == null ? null : fassignedtoId.trim();
    }
